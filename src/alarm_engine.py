...
HEART_RATE_RANGE = (60, 80)  # Normal heart rate range: 60-100 bpm
SPO2_RANGE = (98, 100)  # Normal SpO2 range: 95-100%
RESPIRATORY_RATE_RANGE = (12, 20)  # Normal respiratory rate: 12-20 breaths per minute
TEMP_RANGE = (34, 37.5)  # Normal body temperature range: 36.5-37.5 °C
